...
internal class ReviewRepositoryImpl : ReviewRepository {
    ...
    override suspend fun getReview(reviewId: String): CheckieReview {
        return CheckieReview(
            ...
            rating = 8,
            picturesUri = listOf(
                "https://images.unsplash.com/photo-1707003839758-70d341e99a51?q=80&w=2576&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            ...
            reviewText = "Extraordinary. Meets an elite standard by which you judge all other restaurants. The staff is always ready to help, the premises are extremely clean, the atmosphere is lovely, and the food is both delicious and beautifully presented. Extraordinary. Meets an elite standard by which you judge all other restaurants. The staff is always ready to help, the premises are extremely clean, the atmosphere is lovely, and the food is both delicious and beautifully presented.",
            creationDate = Date(),
        )
    }
}